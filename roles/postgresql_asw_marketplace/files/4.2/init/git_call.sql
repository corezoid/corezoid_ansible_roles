...
CREATE DOMAIN node_id AS character varying(100) NOT NULL;
...
CREATE TABLE "js-code-hub" (
    ...
    status package_status DEFAULT 'new'::package_status
);
...
ALTER TABLE ONLY compiled_deps
...
ALTER TABLE ONLY "js-code-hub-dep-node"
