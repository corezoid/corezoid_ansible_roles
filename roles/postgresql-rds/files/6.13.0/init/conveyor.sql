...
\restrict YmWP1s1OCoawXjnETOaGiT6JWfMfljAmx9g7aNzxrcg9yjE1E7zPoSQ1dbW8uOv
...
CREATE TABLE public.conveyor_auth (
    conveyor_id integer,
    type smallint,
    data text
);
...
CREATE TABLE public.conveyor_billing_aggregation_checkpoint (
...
CREATE TABLE public.conveyor_billing_events (
    id bigint NOT NULL,
    user_id integer,
    ts integer NOT NULL,
    tacts_count integer NOT NULL,
...
CREATE SEQUENCE public.conveyor_billing_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.conveyor_billing_events_id_seq OWNED BY public.conveyor_billing_events.id;
...
CREATE TABLE public.corezoid_auth_password_history (
    id integer NOT NULL,
    user_id integer NOT NULL,
    create_time integer DEFAULT (date_part('epoch'::text, now()))::integer,
    algo character varying(10) NOT NULL,
    hash character varying(255) NOT NULL
);



CREATE SEQUENCE public.corezoid_auth_password_history_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.corezoid_auth_password_history_id_seq OWNED BY public.corezoid_auth_password_history.id;
...
CREATE TABLE public.entity_settings (
    ...
    company_id character varying(36) NOT NULL,
    max_versions smallint DEFAULT 10,
    autosave_versions boolean DEFAULT true
);
...
CREATE SEQUENCE public.env_vars_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.env_vars_id_seq OWNED BY public.env_vars.id;
...
CREATE TABLE public.task_store_settings (
...
ALTER TABLE ONLY public.conveyor_billing_events ALTER COLUMN id SET DEFAULT nextval('public.conveyor_billing_events_id_seq'::regclass);
...
ALTER TABLE ONLY public.corezoid_auth_password_history ALTER COLUMN id SET DEFAULT nextval('public.corezoid_auth_password_history_id_seq'::regclass);
...
ALTER TABLE ONLY public.env_vars ALTER COLUMN id SET DEFAULT nextval('public.env_vars_id_seq'::regclass);
...
ALTER TABLE ONLY public.conveyor_billing_aggregation_checkpoint
    ADD CONSTRAINT conveyor_billing_aggregation_checkpoint_pkey PRIMARY KEY (aggregation_type);



ALTER TABLE ONLY public.conveyor_billing_events
    ADD CONSTRAINT conveyor_billing_events_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.corezoid_auth_password_history
    ADD CONSTRAINT corezoid_auth_password_history_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.entity_settings
    ADD CONSTRAINT entity_settings_pkey PRIMARY KEY (obj_id, obj_type);
...
ALTER TABLE ONLY public.conveyor_billing_daily
    ADD CONSTRAINT pk_conveyor_billing_daily PRIMARY KEY (conveyor_id, user_id, ts);



ALTER TABLE ONLY public.conveyor_billing_hourly
    ADD CONSTRAINT pk_conveyor_billing_hourly PRIMARY KEY (conveyor_id, user_id, ts);



ALTER TABLE ONLY public.conveyor_billing_weekly
    ADD CONSTRAINT pk_conveyor_billing_weekly PRIMARY KEY (conveyor_id, user_id, ts);
...
ALTER TABLE ONLY public.task_store_settings
    ADD CONSTRAINT task_store_settings_pkey PRIMARY KEY (obj_id, obj_type);
...
CREATE INDEX aliases_stage_company_project_active ON public.aliases USING btree (stage_id, company_id, project_id) WHERE (status <> 3);



CREATE INDEX aliases_stage_id_id_version ON public.aliases USING btree (stage_id, id, version) WHERE (version IS NOT NULL);
...
CREATE UNIQUE INDEX conveyor_auth_conveyor ON public.conveyor_auth USING btree (conveyor_id);
...
CREATE UNIQUE INDEX corezoid_auth_password_history_user_id_algo_hash_idx ON public.corezoid_auth_password_history USING btree (user_id, algo, hash);



CREATE INDEX corezoid_auth_password_history_user_id_idx ON public.corezoid_auth_password_history USING btree (user_id);



CREATE INDEX env_vars_stage_company_project_active ON public.env_vars USING btree (stage_id, company_id, project_id) WHERE (status <> 3);



CREATE UNIQUE INDEX env_vars_unique_short_name_company_id_project_id_stage_id_key ON public.env_vars USING btree (short_name, company_id, project_id, stage_id) WHERE (status <> 3);
...
CREATE INDEX ix_conveyor_billing_daily_conveyor_id_ts ON public.conveyor_billing_daily USING btree (conveyor_id, ts);



CREATE INDEX ix_conveyor_billing_daily_ts ON public.conveyor_billing_daily USING btree (ts);



CREATE INDEX ix_conveyor_billing_daily_user_id_ts ON public.conveyor_billing_daily USING btree (user_id, ts);



CREATE INDEX ix_conveyor_billing_hourly_conveyor_id_ts ON public.conveyor_billing_hourly USING btree (conveyor_id, ts);



CREATE INDEX ix_conveyor_billing_hourly_ts ON public.conveyor_billing_hourly USING btree (ts);



CREATE INDEX ix_conveyor_billing_hourly_user_id_ts ON public.conveyor_billing_hourly USING btree (user_id, ts);
...
CREATE INDEX ix_conveyor_billing_weekly_conveyor_id_ts ON public.conveyor_billing_weekly USING btree (conveyor_id, ts);



CREATE INDEX ix_conveyor_billing_weekly_ts ON public.conveyor_billing_weekly USING btree (ts);



CREATE INDEX ix_conveyor_billing_weekly_user_id_ts ON public.conveyor_billing_weekly USING btree (user_id, ts);
...
CREATE UNIQUE INDEX user_groups_ext_id_idx ON public.user_groups USING btree (ext_id);
...
\unrestrict YmWP1s1OCoawXjnETOaGiT6JWfMfljAmx9g7aNzxrcg9yjE1E7zPoSQ1dbW8uOv
